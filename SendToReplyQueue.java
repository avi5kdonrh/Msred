...
/*
Here the messages will be sent to the request queue and from its listener to the response queue but there is no 
listener for the response queue
*/
public class SendToReplyQueue {
